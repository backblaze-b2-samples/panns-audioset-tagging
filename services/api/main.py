...
from app.runtime import files, health, metrics, ratelimit, tagging, upload  # noqa: E402
...
API_TITLE = "PANNs AudioSet Tagging API"
API_DESCRIPTION = (
    "Local API for PANNs AudioSet Tagging: ingest audio clips to Backblaze B2, "
    "tag them locally with PANNs (527-class AudioSet labels + a 2048-dim "
    "embedding), and store every artifact — audio, per-clip tag JSON, and the "
    "labels_index.jsonl manifest — in B2 over the S3-compatible API. This "
